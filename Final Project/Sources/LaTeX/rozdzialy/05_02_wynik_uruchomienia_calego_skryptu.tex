...
\lstinputlisting[caption=Wynik uruchomienia całego skryptu tworzącego w trybie wsadowym, label={lst:create-objects}]{../Logs/skrypt_tworzacy_obiekty_w_bazie_danych.sql-second-run.log}